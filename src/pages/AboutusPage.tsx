      ...
      <section className="py-12 sm:py-14 lg:py-20 bg-gray-50 overflow-hidden" id="about">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            {/* Left Content */}
            <div>
              <span className="text-[#FF0000] tracking-wider uppercase text-sm mb-4 block font-[600] select-none">
                About Prachha Tech
              </span>

              <h2 className="text-2xl sm:text-3xl lg:text-4xl text-gray-900 mb-6 font-[600] select-none">
                Transforming Ideas Into <span className="text-[#FF0000] select-none"> Scalable Digital Products </span>
              </h2>
      ...
      <section className="py-12 sm:py-14 lg:py-20 bg-gray-50 overflow-hidden">
        <div className="container mx-auto px-4 space-y-20">
          ...
          >
            ...
            {/* Content */}
            <div>
              <span className="text-red-500  uppercase tracking-wide font-bold text-sm select-none">
                Our Mission
              </span>

              <h2 className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mt-3 mb-5 select-none">
          ...
          <motion.div
            ...
            <div className=" md:text-left order-2 md:order-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mt-3 mb-5 select-none">
