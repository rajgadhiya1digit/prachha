    ...
    <section className="relative py-12 sm:py-14 lg:py-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-40">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-red-600/30 via-transparent to-pink-600/30 animate-pulse"></div>
          <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-bl from-purple-600/20 via-transparent to-blue-600/20 animate-pulse"></div>
        </div>
        ...
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-red-400 rounded-full opacity-40 blur-sm animate-bounce"
            style={{
        ...
        <div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[500px] md:w-[700px] lg:w-[800px] h-[300px] sm:h-[500px] md:h-[700px] lg:h-[800px] rounded-full blur-3xl"
          style={{
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-6 sm:mb-10 leading-relaxed max-w-2xl sm:max-w-3xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto px-4">
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-r from-red-600 to-pink-600 rounded-xl sm:rounded-2xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity"></div>
              <div className="relative text-center bg-white/5 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-white/20 hover:border-red-500/50 transition-all hover:transform hover:scale-105">
                ...
                <a href="mailto:info@onedigittech.com" className="text-gray-300 hover:text-red-400 transition-colors text-xs sm:text-sm break-all">
                  info@prachha.tech
                </a>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl sm:rounded-2xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity"></div>
              <div className="relative text-center bg-white/5 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-white/20 hover:border-red-500/50 transition-all hover:transform hover:scale-105">
